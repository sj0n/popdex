 ...
 */
export function createMockPokemonWorker(
  overrides: {
    pokemon?:
      | unknown
      | ((name: string, context?: RequestContext) => Promise<Response>);
    locations?:
      | unknown
      | ((name: string, context?: RequestContext) => Promise<Response>);
    moves?:
  ...
  return {
    ...
    getPokemonLocations: vi.fn(
      async (name: string, context?: RequestContext) => {
